...
export const IncomeTaxInstDetailPage = () => {
  let {id}=useParams()
  ...
  let handleSubmit=async(transctions)=>{
    ...
    navigate('/incomelayout/incometaxinst')
  }
  ...
  return (
    ...
    <div class="mx-auto w-48 h-40 relative -mt-16 border-4 border-white  overflow-hidden">
...
export default IncomeTaxInstDetailPage
