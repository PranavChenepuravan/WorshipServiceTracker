...
export const PilgReviewInst = () => {
    ...
    useEffect(() => {
        let fetchdata = async () => {
            let response = await axios.get(`http://localhost:4000/pilgrim/reviewinst`)
    ...
    return (
        <>
            ...
            <button type="button" className="text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 my-[5%] w-[5%]"><Link to='/pilglayout/pilgbookinglist'>List</Link></button>
                        ...
                        <div className='flex'>
                         <div class="p-6 pt-0">
                            <button
                                ...
                                type="button">
                                    <Link to={`/pilglayout/pilgreviewadd/${item._id}`}>Review</Link>
                            </button>
                         </div>
                         <div class="p-6 pt-0">
                         </div>
