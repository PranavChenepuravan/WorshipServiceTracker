      ...
      <ul className="space-y-2 font-medium">
         ...
         <li>
            <a href="#" className="flex items-center p-2 text-gray-50 rounded-lg dark:text-white hover:bg-black dark:hover:bg-gray-700 group">
               ...
               <div className='pl-4'><Link to='/admin/viewinst'>Institution</Link></div>
            </a>
         </li>
         <li>
            <a href="#" className="flex items-center p-2 text-gray-50 rounded-lg dark:text-white hover:bg-black dark:hover:bg-gray-700 group">
               ...
               <div className='pl-4'><Link to='/admin/viewincometax'>Income Tax</Link></div>
            </a>
         </li>
         <li>
            <a href="#" className="flex items-center p-2 text-gray-50 rounded-lg dark:text-white hover:bg-black dark:hover:bg-gray-700 group">
               ...
               <div className='pl-4'><Link to='/admin/viewarchaeology'>Archaeology</Link></div>
            </a>
         </li>
         <li>
            <a href="#" className="flex items-center p-2 text-gray-50 rounded-lg dark:text-white hover:bg-black dark:hover:bg-gray-700 group">
               ...
               <div className='pl-4'><Link to='/admin/viewpilgrim'>Pilgrim</Link></div>
            </a>
         </li>
         <li>
            <a href="#" className="flex items-center p-2 text-gray-50 rounded-lg dark:text-white hover:bg-black dark:hover:bg-gray-700 group">
